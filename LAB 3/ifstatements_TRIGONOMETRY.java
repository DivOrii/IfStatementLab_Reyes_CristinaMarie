...
// === PROBLEM 1 ===
        ...
        switch (Ch) {
            ...
            case 1:
                // this tells us the ratio of the OPPOSITE side to the hypotenuse.
                System.out.println("Results: ");
                System.out.println("Sine: " + Math.sin(rad));
                break;

            case 2:
                // Cosine tells us the ratio of the ADJACENT side to the hypotenuse.
                System.out.println("Results: ");
            ...
            case 3:
                ...
                double normalAngle3 = Angle % 180;

                if (Math.abs(normalAngle3 - 90) < 1 ||
                        Math.abs(normalAngle3 + 90) < 1) {
                    System.out.println("WARNING!! TANGENT is undefined or almost very very close to being as undefined.");
                } else {
                    System.out.println("Results: ");
            ...
            case 4:
                ...
                double normalAngle4 = Angle % 180;
                if (Math.abs(normalAngle4 - 90) < 1 ||
                        Math.abs(normalAngle4 + 90) < 1) {
                    System.out.println("WARNING!! TANGENT is undefined or almost very very close to being as undefined.");
                } else {
                    System.out.println("Tangent: " + Math.tan(rad));
                }
            ...
            default:
                System.out.println("Whomp whomp, invalid choice.");
        }
...
// CRITICAL THINKING QUESTIONS!@!
        ...
        // How could you modify this program to also calculate reciprocal functions (cosecant, secant, cotangent)?
         /*
         we can add more formulas for them to make it more fully and more functional, like an absolute calculator than can make you more dyslexic.
...
// === PROBLEM 2 ===
        ...
        if (angle == 0 || angle == 90 || angle == 180 || angle == 270) {
            ...
            // Finding which quadrant the angle belongs to
            int quadrant;
...
// === PROBLEM 3 ===
            ...
            // Choose what information the user already knows
            switch (option) {
                ...
                case 1:
                    ...
                    // Making sure both sides are positive
                    if (a <= 0 || b <= 0) {
                ...
                // Option 2, if the user knows one side and one angle
                case 2:
                    ...
                    if (side <= 0 || inputtednangle <= 0 || inputtednangle >= 90) {
                        ...
                        double hypote = side / Math.sin(radians);

                        // tan(angle) = opposite / adjacent
                        double adjacent = side / Math.tan(radians);

                        // The other small angle = 90 - known angle
                ...
                // If the user picks anything other than 1 or 2
                default:
...
// === PROBLEM 4 ===
            ...
            int identity1 = (difference1 <= tolerance) ? 1 : 2;
            ...
            if (Math.abs(cos) < tolerance) {
                ...
                // Check if the difference is small enough
                int identity2 = (difference2 <= tolerance) ? 1 : 2;
            ...
            // Check if the difference is small enough
            int identity3 = (difference3 <= tolerance) ? 1 : 2;
            ...
            // 1. Why do we need a tolerance when comparing floating-point values?
                ...
                exactly the same. Tolerance lets us accept very small differences
                as equal.
                */
            ...
            // 2. Which identity might be most susceptible to floating-point precision issues and why?
                /*
                Identity 2 might have more precision issues because it uses
                division by cosine. When cosine is very close to 0, the values
                of tangent and secant can become very large, which can cause
                bigger rounding errors.
                */


            // 3. How could you extend this program to verify more complex identities?
                /*
                I could add more identities by calculating the left side and
                right side of each identity and comparing them using the same
                tolerance. We could also let the user choose which identity
                they want to check.
                */
...
// === PROBLEM 5 ===
            ...
            // Decide what position the wave is in
            int wavePosition;
            ...
            if (Math.abs(waveValue - amplitude) < mootolerance) {
                ...
                wavePosition = 2; // Trough

            } else if (Math.abs(waveValue) < mootolerance) {
                wavePosition = 3; // Zero-crossing

            } else {
                wavePosition = 4; // Between positions
            }

            // Use switch to display the wave's position
            switch (wavePosition) {
